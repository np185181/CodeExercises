...
using Retalix.StoreServices.BusinessComponents.DMS.DeleteAllProviders;
using Retalix.StoreServices.BusinessComponents.DMS.ECT;
...
using Retalix.StoreServices.Common.DMS.ECT;
...
using Retalix.StoreServices.Model.Inventory.Legacy.Product;
...
namespace Retalix.StoreServer.CoreConfiguration.CoreComponents
{
    internal class BusinessComponents : CastleConfigurationInstaller
    {
        ...
        public override void Install(IComponentInstaller builder)
        {
            ...
            builder.Register(Component.For<ILegacyProductDao>().Named("ILegacyProductDao").ImplementedBy<LegacyProductDao>().LifeStyle.Singleton);
            ...
            builder.RegisterSingleton<ILegacyProductFactory, ProductFactory>();
            ...
            builder.Register(
                Component.For<ILegacyProductInventoryLocations>().Named("ProductInventoryLocations").
                          ImplementedBy<ProductInventoryLocations>().LifeStyle.Transient);
            ...
            builder.Register(Component.For<ITransactionTypeNameStrategy>().Named("TransactionTypeNameStrategy")
            ...
            builder.Register(Component.For<ILegacyProduct>().Named("IProduct").ImplementedBy<Product>().LifeStyle.Transient);
            ...
            builder.Register(Component.For<IFundTransferTransactionClosingValidator>()
                .Named("ValidateBusinessDate").ImplementedBy<StoreServer.BusinessComponents.Finance.FundTransfer.Validators.ValidateBusinessDate>().LifeStyle.Transient);
            ...
            builder.Register(
                Component.For<IDeleteAllProvidersExecutorBc>().Named("DeleteAllProvidersExecutorBc").
                          ImplementedBy<DeleteAllProvidersExecutorBc>().LifeStyle.Transient);

            builder.Register(
                Component.For<IDeleteAllProvidersDao>().Named("DeleteAllProvidersDao").ImplementedBy
                    <DeleteAllProvidersDao>().LifeStyle.Transient);

            builder.Register(
                Component.For<IDeleteAllProvidersDaoExecuter>().Named("DeleteAllProvidersDaoExecuter").ImplementedBy
                    <DeleteAllProvidersDaoExecuter>().LifeStyle.Transient);
            ...
            builder.Register(Component.For<IDataSecurityFilter>().ImplementedBy<DataSecurityFilter>().LifeStyle.Transient);
            ...
            builder.Register(Component.For<IUserRolesDao>().Named("IUserRolesDao").ImplementedBy<UserRolesDao>().LifeStyle.Singleton);
        }
        ...
        private static void RegisterEctComponents(IComponentInstaller builder)
        {
            var ectEnabled = bool.TrueString.Equals(ConfigurationManager.AppSettings["ECT.IsActive"], StringComparison.InvariantCultureIgnoreCase);
            if (ectEnabled)
            {
                builder.Register(Component.For<IDistributionActivityPublisher>().Named("IDistributionActivityPublisher")
                        .ImplementedBy<DistributionActivityPublisher>().LifeStyle.Singleton);

                builder.Register(Component.For<IDistributedActivitySkipHandler>().Named("IDistributedActivitySkipHandler")
                        .ImplementedBy<DistributedActivitySkipHandler>().LifeStyle.Singleton);
            }
            else
            {
                builder.Register(Component.For<IDistributionActivityPublisher>().Named("IDistributionActivityPublisher")
                        .ImplementedBy<DisabledDistributionActivityPublisher>().LifeStyle.Singleton);

                builder.Register(Component.For<IDistributedActivitySkipHandler>().Named("IDistributedActivitySkipHandler")
                        .ImplementedBy<DisabledDistributedActivitySkipHandler>().LifeStyle.Singleton);
            }
        }
    }
}
