...
using Retalix.StoreServices.BusinessServices.FrontEnd.DMS.GetAllProviders;
...
using Retalix.StoreServices.BusinessServices.FrontEnd.ProductInventoryLocations.Maintenance;
...
using Retalix.StoreServices.BusinessServices.FrontEnd.UserRoles;
...
LifeStyle.Transient);
      ...
      LifeStyle.Transient);
            ...
            builder.Register(Component.For<IBusinessService>().Named("DeleteAllProvidersService").ImplementedBy
                    <DeleteAllProvidersService>().LifeStyle.Transient);
            ...
            builder.Register(Component.For<IBusinessService>().Named("ProductLocationsMaintenanceService").ImplementedBy
                      <ProductLocationsMaintenanceService>().LifeStyle.Transient);
        ...
        <AdvertisementCategoryLookUpService>().LifeStyle.Transient);
          ...
          <OpenAccountBalanceFindService>().LifeStyle.Transient);
            ...
            builder.Register(Component.For<IBusinessService>().Named("GetAllProvidersService")
                         .ImplementedBy<GetAllProvidersService>().LifeStyle.Transient);
            ...
            // builder.Register(Component.For<object>().Named("CouponMaintenanceService").ImplementedBy<CouponMaintenanceService>().LifeStyle.Transient);
           ...
           <MenuDisplayTermsLookupServiceDispatcher>().LifeStyle.Transient);
            ...
            if (ConfigurationManager.AppSettings["UseClaim"] == "true") //temporaily allow working with handshake - as soon as we complete this we will remove this if
            {
           ...
           .ImplementedBy<CustomerOrderNoteModifyService>().LifeStyle.Transient);
            ...
            //TODO: move "DeleteEventHistoryActivity" to OrderProcessTransitionActivities.DeleteEventHistoryActivityName
            ...
            builder.Register(Component.For<IBusinessService>().Named("UserRolesLookupService").ImplementedBy<UserRolesLookupService>().
                LifeStyle.Transient);

            builder.Register(Component.For<IBusinessService>().Named("UserRolesMaintenanceService").ImplementedBy<UserRolesMaintenanceService>().
                LifeStyle.Transient);
        }
